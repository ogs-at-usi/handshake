class Message {
    ...
    get sender() {
        if (!(this.#sender instanceof User)) this.#sender = getUser(this.#sender);
        return this.#sender;
    };
    ...
    get content() {
        if (this.#content === null) this.#content = Message.CONTENT[this.#type](this);
        return this.#content;
    };
    ...
    get seen() {
        if (this.#seen.length > 0 && !(this.#seen[0] instanceof User)) this.#seen = this.#seen.map(uid => getUser(uid));
        return this.#seen;
    };
};
